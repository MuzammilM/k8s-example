...
kubectl set image deployments/client-deployment client=muzammilmomin/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=muzammilmomin/multi-worker:$SHA